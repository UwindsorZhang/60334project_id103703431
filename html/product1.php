...
<header><h1>Using CSS for Page Layouts</h1>  
...
if($res['user_code']=="3"){
echo '<p><a href="product2.php">Book add, delete or change state</a></p>';
echo '<p><a href="product3.php">Pie Chart Of Record Time</a></p>';
}
?>
</nav>

<article>
<h2 class="title">Search book by title, if you see the borrow button, you can borrow it.(or others have borrowed it)</h2>
<p class="copy">
<?php
require('search.php');
?>
